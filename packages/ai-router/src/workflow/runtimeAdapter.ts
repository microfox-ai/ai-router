/**
 * Generic, provider-agnostic workflow runtime contracts.
 *
 * These types describe the minimal surface area that ai-router expects from
 * any workflow runtime (Vercel `workflow`, Upstash Workflow, etc.).
 *
 * Concrete providers implement these interfaces in their own adapters.
 *
 * NOTE: This file intentionally does not contain any concrete provider
 * implementation. Vercel / Upstash adapters live in their own modules and
 * import these shared types.
 */
...
/**
 * Minimal contract that ai-router expects from any workflow runtime.
 *
