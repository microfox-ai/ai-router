...
Typical workflow:
  ...
  3. $ ai-worker dev                  run + test workers locally (no AWS needed)
  4. $ ai-worker compile              compile workers into .serverless-workers/
  5. $ npx microfox@latest deploy     compile + push to the Microfox platform
`
  );
